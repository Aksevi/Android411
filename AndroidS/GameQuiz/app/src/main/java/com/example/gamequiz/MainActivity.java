    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MainActivity.this, GameLevels.class); // переходим со страницы MainActivity на GameLevels
                startActivity(intent); // собстваенно сам переход
            }
        });
